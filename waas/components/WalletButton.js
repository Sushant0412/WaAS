    ...
    return (
        <div className="flex flex-col items-center gap-2">
            <button
                ...
                className={`group relative flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-orange-500 to-pink-500 text-white font-semibold transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl hover:shadow-orange-500/40 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 overflow-hidden ${className}`}
            >
                {/* MetaMask Fox Icon */}
                <svg className="w-6 h-6 transition-transform duration-300 group-hover:rotate-12" viewBox="0 0 35 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-pink-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-xl"></div>
            </button>
